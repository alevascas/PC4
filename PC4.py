...
if pagina_seleccionada == 'Inicio':
    ...
    y actualmente estudio Ciencias de la comunicación en la universidad Pontifica Univerdad Católica del Perú. 
    """
    ...
    st.markdown("<h2 style='text-align: center;'>Mi primera vez programando</h2>", unsafe_allow_html=True)
